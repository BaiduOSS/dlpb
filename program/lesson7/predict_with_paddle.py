...
"""
  ...
  使用PaddlePaddle框架实现个性化电影推荐系统的结果预测，
...
def main():
    ...
    # 配置网络结构
    inference, feeding = network_config()
    ...
    # 从文件中读取参数
    with open('params_pass_9.tar', 'r') as param_file:
        PARAMETERS = paddle.parameters.Parameters.from_tar(param_file)
